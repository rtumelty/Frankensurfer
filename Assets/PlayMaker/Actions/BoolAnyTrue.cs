...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HutongGames.PlayMaker.Tooltip("Tests if any of the given Bool Variables are True.")]
	public class BoolAnyTrue : FsmStateAction
	{
        ...
        [HutongGames.PlayMaker.Tooltip("Event to send if any of the Bool variables are True.")]
