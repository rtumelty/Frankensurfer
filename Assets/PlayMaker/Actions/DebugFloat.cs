...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HutongGames.PlayMaker.Tooltip("Logs the value of a Float Variable in the PlayMaker Log Window.")]
	public class DebugFloat : FsmStateAction
	{
        ...
        [HutongGames.PlayMaker.Tooltip("Prints the value of a Float variable in the PlayMaker log window.")]
