...
{	
	...
	[HutongGames.PlayMaker.Tooltip("Gets Location Info from a mobile device. NOTE: Use StartLocationService before trying to get location info.")]
	public class GetLocationInfo : FsmStateAction
	{
		...
		//[UIHint(UIHint.Variable)]
		//[HutongGames.PlayMaker.Tooltip("Timestamp (in seconds since the game started) when location was last updated.")]
		//public FsmFloat timeStamp;
		[HutongGames.PlayMaker.Tooltip("Event to send if the location cannot be queried.")]
