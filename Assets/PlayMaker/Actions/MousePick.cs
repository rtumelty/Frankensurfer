...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HutongGames.PlayMaker.Tooltip("Perform a Mouse Pick on the scene and stores the results. Use Ray Distance to set how close the camera must be to pick the object.")]
