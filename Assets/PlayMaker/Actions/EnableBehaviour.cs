...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HutongGames.PlayMaker.Tooltip("Enables/Disables a Behaviour on a GameObject. Optionally reset the Behaviour on exit - useful if you only want the Behaviour to be active while this state is active.")]
