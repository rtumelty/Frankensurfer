...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HutongGames.PlayMaker.Tooltip("Tests if all the given Bool Variables are True.")]
	public class BoolAllTrue : FsmStateAction
	{
        ...
        [HutongGames.PlayMaker.Tooltip("Event to send if all the Bool variables are True.")]
