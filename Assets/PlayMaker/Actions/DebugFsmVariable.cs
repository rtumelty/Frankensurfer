...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [HutongGames.PlayMaker.Tooltip("Print the value of an FSM Variable in the PlayMaker Log Window.")]
    public class DebugFsmVariable : FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.Tooltip("Variable to print to the PlayMaker log window.")]
